...
** Last update Sun Nov 11 19:35:24 2012 louis-philippe baron
*/
...
int		check_expr_base_ops(char *expr, char *base, char *ops, long size)
{
  long		i;
...
int		check_parenthesis(char *ops, char *expr, long size)
{
  long		i;
  int		parenthesis;
...
int		check_ops_bef_par(char *base, char *ops, char *expr, long size)
{
  long		i;
...
int		check_first_and_last(char *expr, char *ops, long size)
{
